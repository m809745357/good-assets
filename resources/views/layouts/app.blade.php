...
<head>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=sZqzEniflDZuCclfbUG7wg6M"></script>
                        ...
                        @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="margin-top: 17.5px;">
                                    <img src="{{ Auth::user()->headimgurl }}" style="border-radius: 50%;width: 50px;"> {{ Auth::user()->name }} <span class="caret"></span>
                                </a>
